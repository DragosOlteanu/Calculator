...
// Functie care se ocupa de click-ul pe AC
function handleAllClearClick() {
    // Cand dam click pe AC, se reinitializeaza calculul
    operation = 'allClear';
    ...
    operation = ''
    result.innerHTML = '<p>Aici va fi afisat rezultatul.</p> '
    ;
  }
// Functie care se ocupa de click-ul  pe division
...
// Functie care se ocupa de click-ul pe plus
